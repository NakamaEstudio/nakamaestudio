...
import { getTestimonialPadData } from '../../data/testimonialpad';
...
function TestimonialPad({
  ...
  const TestimonialDetails = getTestimonialPadData();
  const testimonials = useRef(null);
  const isLine = styleBox === 'line';
  const isCorner = styleBox === 'corner';

  useEffect(() => {
    const nav = testimonials.current.querySelector('.testimonial-nav .swiper')
      ?.swiper;
