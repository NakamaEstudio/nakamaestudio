...
function Post1({className, ...restProps}) {
    ...
    return (
        <Layout modelRight={{children: <ModalContact/>, propsModal: {textBtn: "Contact"}}}>
            <Head>
                <title>
Desvendando a Essência da Sua Marca: Criando uma Identidade Memorável  | Estúdio Nákama</title>
            </Head>
            ...
            <div className="news-content mb-section mt-40">
                <div className="single-post container post-content  ">
                    ...
                    <h3>Você já se perguntou sobre a verdadeira essência por trás de uma marca poderosa? Aquela sensação instantânea de reconhecimento quando você vê um logotipo ou interage com uma empresa? É tudo sobre a aura da marca.</h3>
                    <p>No Estúdio Nákama, entendemos o poder de uma identidade única e como ela pode influenciar a percepção do seu público. Nosso serviço Aura - Identidade e Posicionamento de Marca foi meticulosamente desenvolvido para ajudar a desvendar e consolidar essa essência exclusiva para o seu negócio.
</p>

<h3>
O que é a Aura da Marca?
</h3>

                    <blockquote className="block-quote">
                        <p>A aura de uma marca é mais do que um logotipo elegante ou uma paleta de cores vibrantes. É a narrativa emocional, é a personalidade e é a conexão que sua marca estabelece com o mundo. Trabalhamos lado a lado com você para entender sua história, seus valores e sua visão, transformando esses elementos em uma identidade tangível.
.</p>
                    </blockquote>
                    ...
                    <ul>
                        <li>-<strong> Diagnóstico de Branding Personalizado</strong>: Nossa jornada começa com uma análise profunda do seu negócio. Compreendemos seus objetivos, seu mercado-alvo e a concorrência para definir a base da sua identidade.<br/><br/>
 </li>
                        <li>-<strong> Desenvolvimento do Naming e Logotipo</strong>: Criamos um nome impactante e um logotipo memorável que personificam a essência da sua marca.<br/><br/>
 </li>
                        <li>- <strong>Identidade Visual Coesa</strong>: Desde paletas de cores até tipografia, cada elemento é escolhido estrategicamente para refletir sua identidade.<br/><br/> </li>
                        <li>-<strong> Manual de Marca Detalhado</strong>: Preparamos um guia abrangente para garantir que sua marca seja aplicada consistentemente em todos os canais. </li>
                    
                    </ul>
                    <h3>
                    Por que a Aura Importa?
                    </h3>
                    <p>
                    Uma identidade de marca forte não apenas atrai clientes, mas também constrói lealdade. Ela se torna a base da sua narrativa, garantindo que cada interação seja consistente e impactante.
                    </p>
                    <p>
