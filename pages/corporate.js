    ...
    >
      ...
      <HeaderNormal className="align-content-center text-center">
        ...
        <p className="subtitle p-relative line-shape mt-30">
          <span className="background-section pl-10 pr-10">DESIGN STUDIO</span>
        </p>
      </HeaderNormal>
      {/*========== End Header Normal ==========*/}
      ...
      <div className="p-relative" data-dsn-title="About">
        ...
        >
          <TitleSection
            className="align-items-start mb-50 text-right"
          ...
          <p className="mb-15">
            We are Leading International Consulting Specializingin Business &
          ...
          <p>
            ...
            techno enthusiasts feel identified. We generated a simple logo that
            is the basis for generating a geometric and liquid system.{' '}
          </p>
          <Button
            className="mt-30"
            href="about"
      ...
      {/*Start Service*/}
      <div className="section-margin container" data-dsn-title="our Services">
      ...
      {/*========== Work Section ========== */}
      <div className="section-margin container" data-dsn-title="our Work">
        <TitleSection description={'Our Works'}>AWESOME DESIGNS</TitleSection>
        <Portfolio
      ...
      <div className="section-margin container" data-dsn-title="Testimonial">
        <TitleSection description={'Feedback'}>What People Saying</TitleSection>
        <Testimonial
      ...
      {/*Start Blog*/}
      <div className="section-margin container" data-dsn-title="our Blog">
