    ...
    >
      ...
      >
        <p className="subtitle p-relative line-shape  dsn-load-animate">
          <span className="background-main pl-10 pr-10"> NEWS & IDEAS </span>
        </p>
        <h1 className="title text-uppercase">Our Stories</h1>
      </HeaderNormal>
      {/*========== End Header Normal ==========*/}

      <div className="dsn-container section-margin">
        <Blog
          styleBlog="our-blog-classic our-blog-full-img"
          col={4}
          colTablet={2}
          colMobile={1}
          rowGap={50}
