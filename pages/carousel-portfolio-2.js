...
function Home() {
  return (
    ...
    >
      ...
      <div
        className="p-relative d-flex align-items-center full-width"
        style={{ height: '100vh' }}
      >
        <PortfolioSwiper
          grabCursor
          desktop={{ spaceBetween: 0, slidesPerView: 1.5 }}
          tablet={{ spaceBetween: 0, slidesPerView: 1.25 }}
          mobile={{ spaceBetween: 0, slidesPerView: 1 }}
          style={{ width: '100%' }}
          stylePortfolio="work-section work-no-scale"
          className="v-dark-head title-inherit title-h2 text-center"
          centeredSlides
          loop
          blur
          parallax
