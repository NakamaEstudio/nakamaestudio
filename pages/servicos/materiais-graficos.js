...
function Materiaisgraficos() {
  ...
  return (
    ...
    >
      ...
      {/*<!-- ========== About Section ========== */}
      <section
        className="about-me p-relative section-margin container "
      ...
      <div className="p-relative section-padding" data-dsn-title="Skills">
        <div className="box-im box-im-100 h-100 p-absolute over-hidden top-0">
          <ParallaxImage
            alt={''}
            src={'/img/header.jpg'}
            height={'100%'}
        ...
        <Skills
          className="p-relative z-index-1  container"
          col={4}
          colTablet={2}
        >
