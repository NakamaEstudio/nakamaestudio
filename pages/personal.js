...
function Personal() {
  ...
  return (
    ...
    >
      ...
      {/*Start Service*/}
      <div className="section-margin container" data-dsn-title="My Services">
        <TitleSection
          className="align-items-center text-center"
      ...
      {/*========== Work Section ========== */}
      <div className="section-margin container" data-dsn-title="My Work">
      ...
      <div className="section-margin container" data-dsn-title="Testimonials">
